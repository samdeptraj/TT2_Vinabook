    ...
    return (
        <>
            ...
            <div className="nav flex-column nav-pills text-left mt-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <div className="nav-link btn active text-left" id="v-pills-profile-tab" data-toggle="pill" data-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Đơn hàng</div>
                ...
                <div className="nav-link btn text-left" id="v-pills-settings-tab" data-toggle="pill" data-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">Sản phẩm</div>
                <div className="nav-link btn text-left" id="v-pills-settings-tab" data-toggle="pill" data-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">Doanh thu</div>
            </div>
        </>
    )
}
